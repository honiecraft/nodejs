...
import Image from "../../shared/img/Image";
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4 mb-md-0">
                    <Link className="category-item" to={"/shop?category=mac"}>
                      <img className="img-fluid" src={Image.img2} alt="Mac" />
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-4 mb-4 mb-md-0">
                    <Link className="category-item" to={"/shop?category=ipad"}>
                      <img className="img-fluid" src={Image.img3} alt="Ipad" />
                    </Link>
                  </div>
                  <div className="col-md-4 mb-4 mb-md-0">
                    <Link className="category-item" to={"/shop?category=watch"}>
                      <img className="img-fluid" src={Image.img4} alt="Watch" />
                    </Link>
                  </div>
                  <div className="col-md-4 mb-4 mb-md-0">
                    <Link
